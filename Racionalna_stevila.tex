    ...
    \subsection{Racionalna števila}
        ...
        \begin{frame}
            ...
            \only<2->{\begin{alertblock}{}
                Množica racionalnih števil je urejena z relacijo \textit{biti manjši} ($<$) oziroma \textit{biti večji} ($>$). Za ulomka $\frac{a}{b}$ in $\frac{c}{d}$ ($b,d\in\mathbb{N}$) velja natanko ena izmed treh možnosti:
                \begin{enumerate}
