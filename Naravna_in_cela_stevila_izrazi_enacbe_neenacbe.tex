...
\subsection{Urejenost naravnih in celih števil}
    ...
    \begin{frame}
        ...
        \begin{block}{}
            Vsote kvadratov ne moremo razstaviti v množici $\mathbb{Z}$ (oziroma $\mathbb{R}$).
        \end{block}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{block}{}
            Vsote četrtih potenc ne moremo razstaviti v množici $\mathbb{Z}$ (oziroma $\mathbb{R}$).
        \end{block}

    \end{frame}


    %razmisli o smislu zaporedja obravnave
