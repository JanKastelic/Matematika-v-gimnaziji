...
\end{frame}
    ...
    \subsection{Odstotni račun}
        ...
        \begin{frame}
            \only<2->{\begin{exampleblock}{Naloga}
                Pri ekološki pridelavi kmeta pridela $3$ tone pšenice na hektar. 
        ...
        \begin{frame}
            \only<2->{\begin{exampleblock}{Naloga}
                Zidar, ki je za vsako uro svojega dela računal $18~€$, je urno postavko povišal za $15~\%$.
                Koliko zdaj računa za $1$ uro dela? \\~
            \end{exampleblock}}
        ...
        \begin{frame}
            ...
            \only<3->{\begin{exampleblock}{Naloga}
                Koliko kilogramov svežega mesa potrebujemo za pripravo tridesetih $100~g$ zrezkov, 
                če izgubimo pri pečenju $40~\%$ mase mesa. \\~
            \end{exampleblock}}
