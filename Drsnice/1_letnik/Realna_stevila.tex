...
\end{frame}
    ...
    \subsection{Reševanje enačb}
        ...
        \begin{frame}
            ...
            \only<8->{\begin{alertblock}{Enačba z ulomki}
                \only<9->{Pri enačbu, v katerih nastopajo neznake v imenovalcu, smo pozorni na definiranost ulomkov. 
                Nato enačbo preoblikujemo v linearno ali razcepno obliko.}
            \end{alertblock}}
