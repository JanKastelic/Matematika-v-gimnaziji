    ...
    \subsection{Realna števila}
        ...
        \begin{frame}
            ...
            \only<5->{\begin{alertblock}{}
                Med poljubnima racionalnima številoma je neskončno mnogo racionalnih števil in pravimo, da je množica $\mathbb{Q}$ je \textbf{povsod gosta}. 
            \end{alertblock}}
        ...
        \begin{frame}
            ...
            \only<2->{\begin{block}{}
                Množico racionalnih števil lahko, glede na predznak števil, razdelimo na tri množice:
                \begin{itemize}
        ...
        \begin{frame}
            ...
            \only<11->{\begin{block}{}
                ...
                \begin{itemize}
                    ...
                    \item<14-> $x<y \land z>0 \Rightarrow x\cdot z<yz$ in $x\leq y \land z>0 \Rightarrow x z\leq y z$;
                    \item<15-> $x<y \land z<0 \Rightarrow x\cdot z>yz$ in $x\leq y \land z<0 \Rightarrow x z\geq y z$.
                \end{itemize}
