    ...
    \subsection{Množice v pravokotnem koordinatnem sistemu}
        ...
        \begin{frame}[t]
            ...
            \begin{columns}
                ...
                \only<2->{
                    \begin{alertblock}{}
                        Poljubni točki \textcolor{blue}{$T$} v ravnini s pravokotnim koordinatnim sistemom lahko določimo \textbf{koordinate točke}: \only<2-4>{\textcolor{blue}{$T(x_0,y_0)$}}\only<5>{\textcolor{blue}{$T(\textcolor{green}{x_0},y_0)$}}\only<6>{\textcolor{blue}{$T(\textcolor{green}{x_0},\textcolor{darkred}{y_0})$}}. \\
