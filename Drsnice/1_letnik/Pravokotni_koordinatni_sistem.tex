...
\end{frame}
    ...
    \subsection{Razdalja med točkama in razpolovišče daljice}
        ...
        \begin{frame}
            ...
            \only<5->{\begin{alertblock}{Razpolovišče daljice}
                \only<6->{Razpolovišče $S$ daljice $AB$ s krajiščema $A(x_a,y_a)$ in $B(x_b,y_b)$ v ravnini je}
                \only<7->{$$ S\left(\dfrac{x_a+x_b}{2},\dfrac{y_a+y_b}{2}\right). $$}
            \end{alertblock}}
        \end{frame}
