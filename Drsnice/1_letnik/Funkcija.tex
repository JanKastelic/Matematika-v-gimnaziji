...
\subsection{Funkcija}
        ...
        \begin{frame}
            ...
            \vskip-1em
            \begin{alertblock}{Surjektivnost}
            ...
            \vskip-0.5em
            \begin{alertblock}{}
                Funkcija $f:\mathcal{X}\to\mathcal{Y}$ je \textbf{bijektivna}, če je injektivna in surjektivna hkrati -- če je vsak element iz kodomene $\mathcal{Y}$ slika natanko enega elementa domene $\mathcal{X}$.
            \end{alertblock}
        \end{frame}
