    ...
    \subsection{Definicija kotnih funkcij v pravokotnem trikotniku}
        ...
        \begin{frame}
            \only<2->{\begin{exampleblock}{Naloga}
                ...
                \begin{itemize}
                    \item $\sin\alpha=\dfrac{2}{5}$ \\~
                    \item $\cos\alpha=\dfrac{5}{6}$ \\~
                    \item $\tan\alpha=\dfrac{3}{7}$ \\~
                    \item $\cos\beta=\dfrac{4}{7}$ \\~
                    \item $\tan\beta=\dfrac{0.3}{0.2}$ \\~
                \end{itemize}
            \end{exampleblock}}
                ...
                \begin{itemize}
                    \begin{columns}
                        \column{0.42\textwidth}
                            \item $\sin{90^\circ}+\cos{0^\circ}+\tan{45^\circ}$ \\~\\~
                            \item $\dfrac{\tan{30^\circ}}{\sin{60^\circ}}-\dfrac{\tan{60^\circ}}{\cos{60^\circ}}$ \\~\\~
                            \item $\tan{30^\circ}\cdot\dfrac{\sin{45^\circ}}{\cos{30^\circ}}$ \\~\\~
                            \item $\sin{60^\circ}+\cos{30^\circ}-\tan{45^\circ}$ \\~
                        \column{0.42\textwidth}
                            \item $\dfrac{\sin{30^\circ}}{\cos{30^\circ}}$ \\~\\~
                            \item $\dfrac{1-\sin{45^\circ}}{\cos{45^\circ}}$ \\~\\~
                            \item $\dfrac{\sin{90^\circ}}{1-\tan{30^\circ}}$ \\~\\~
                            \item $\cos{45^\circ}+\sin{45^\circ}-3\tan{30^\circ}$ \\~
                    \end{columns}
                \end{itemize}
            \end{exampleblock}}
