...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \subsection{Štirikotnik in pravilni $n$-kotnik}
        ...
        \begin{frame}
            \begin{block}{}
                Paralelograme delimo na \textit{pravokotne} in \textit{poševnokotne}.
            \end{block}

            \begin{alertblock}{Definicja}
                \textbf{Pravokotnik} je pravokotni paralelogram, vsi njegovi notranji koti so pravi.
            \end{alertblock}

            \begin{block}{}
                Diagonali v pravokotniku se razpolavljata.
            \end{block}
