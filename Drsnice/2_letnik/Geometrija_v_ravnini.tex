...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \subsection{Podobnost}
        ...
        \begin{frame}
            ...
            \begin{alertblock}{Definicija}
                Trikotnika $\triangle ABC$ in $\triangle A'B'C'$ sta podobna, če imata enaka razmerja istoležnih vseh stranic in enake vse notranje kote.
                ...
                $$ a:b:c=a':b':c' $$
                $$ \alpha=\alpha' \quad\quad \beta=\beta' \quad\quad \gamma=\gamma' $$
            \end{alertblock}
