    \section{Vektorji v koordinatnem sistemu}
            ...
            \subsection{Lega točke v prostoru}
                ...
                Poljubni točki \textcolor{blue}{$T$} v prostoru s pravokotnim koordinatnim sistemom lahko določimo \textbf{koordinate točke}: 
                        \textcolor{blue}{$T(x_0,y_0,z_0)$}} \textcolor{blue}{$T(\textcolor{green}{x_0},y_0,z_0)$}} \textcolor{blue}{$T(\textcolor{green}{x_0},\textcolor{yellow}{y_0},z_0)$}} \textcolor{blue}{$T(\textcolor{green}{x_0},\textcolor{yellow}{y_0},\textcolor{red}{z_0})$}}. \\
            ...
            \begin{figure}[H]
                \begin{tikzpicture}
                    ...
                    % Marking point T by circle
                    \draw [line width=0.032cm] (5.411545,5.409522) circle (0.040000);%
                    \draw (5.241545,5.379522) node [anchor=south west] { $T$ };}%            
                    ...
                    \draw (5.111545,5.239835) node [anchor=north west] { $\vec{r_T}$ };%
