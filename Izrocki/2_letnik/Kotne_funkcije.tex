...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \section{Razširitev pojma kotne funkcije do polnega kota}
            ...
            \subsection{Kotne funkcije v enotskem krogu}
                    ...
                    \begin{figure}[H]
                        \begin{tikzpicture}
                            ...
                            \draw (6.050000,5.500000) node [anchor=south] { $\textrm{premični~krak}$ };%
            ...
            % \normalsize
                    ...
                    \begin{figure}[H]
                        ...
                        \begin{tikzpicture}
                            ...
                            % Drawing segment T_2 M_2
                            \draw [line width=0.032cm] (2.050000,5.521738) -- (2.050000,4.040000);%
                            ...
                            \draw [line width=0.032cm] (3.960000,4.000000) -- (2.090000,4.000000);%
                            ...
                            \draw [line width=0.032cm] (6.500000,3.960000) -- (6.500000,2.040000);%
                            ...
                            \draw [line width=0.032cm] (3.960000,6.500000) -- (0.915000,6.500000);%
                    ...
                    \end{figure}
                        ...
                        kosinusa suplementarnih kotov sta nasprotno enaka.
            ...
            % \normalsize
                    ...
                    \begin{figure}[H]
                        ...
                        \begin{tikzpicture}
                            ...
                            % Drawing segment T_3 M_3
                            \draw [line width=0.032cm] (2.050000,2.490000) -- (2.050000,3.960000);%
                            ...
                            % Drawing segment E_1 F_1
                            \draw [line width=0.032cm] (6.500000,4.040000) -- (6.500000,5.960000);%
                            ...
                            % Drawing segment E_2 G_1
                            \draw [line width=0.032cm] (4.040000,6.500000) -- (7.085000,6.500000);%
            ...
            % \normalsize
                ...
                \begin{figure}[H]
                        ...
                        \begin{tikzpicture}
                            ...
                            % Drawing segment T_4 M_1
                            \draw [line width=0.032cm] (5.950056,2.490000) -- (5.952116,3.960000);%
                            ...
                            % Drawing segment O M_1
                            \draw [line width=0.032cm] (4.040000,4.000000) -- (5.912172,4.000000);%
                    ...
                    \end{figure}
                        ...
                        $$ \cos\left(360^\circ-\psi\right) = \cos\psi $$                      
                        $$ \tan\left(360^\circ-\psi\right) = -\tan\psi $$
                        $$ \cot\left(360^\circ-\psi\right) = -\cot\psi $$
        ...
        % 
        %     \subsection{Kot $\varphi$ med $\frac{\pi}{2}$ in $\pi$}
        %     % ~\\
        %     % \normalsize
        ...
        % 
        %     \subsection{Kot $\varphi$ med $\pi$ in $\frac{3\pi}{2}$}
        %     % ~\\
        %     % \normalsize
        %     
        %     
        ...
        % 
        %     \subsection{Kot $\varphi$ med $\frac{3\pi}{2}$ in $2\pi$}
        %     % ~\\
        %     % \normalsize
        %     
        %     
    ...
    % \section{Izrazi s kotnimi funkcijami}
    ...
    % \section{Posledice adicijskih izrekov}

    %     
    %         \subsection{Posledice adicijskih izrekov}
    %     

    % \section{Grafa funkcij sinus in kosinus}

    %     
    %         \subsection{Grafa funkcij sinus in kosinus}
    %     

    % \section{Grafa funkcij tangens in kotangens}
    ...
    % \section{Trigonometrijske enačbe}

    %     
    %         \subsection{Trigonometrijske enačbe}
    %     

    % \section{Problemske naloge}
    ...
    % \section{Naklonski kot premice, kot med dvema premicama}
