...
\section{Trikotnik}
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                ...
                % Marking point A by circle
                \draw [line width=0.016cm] (2.000000,1.500000) circle (0.040000);%
                \draw (1.970000,1.530000) node [anchor=north] { $A$ };%
                ...
                % Marking point v_a
                \draw (3.319672,3.083607) node [anchor=west] { $v_a$ };%
                
                % Marking point v_c
                \draw (3.000000,2.100000) node [anchor=west] { $v_c$ };%
                
                % Marking point v_b
                \draw (4.500000,2.100000) node [anchor=south] { $v_b$ };%
                ...
                % Drawing segment A A'
                \draw [line width=0.032cm] (2.025607,1.530729) -- (3.639344,3.467213);%
                \draw [line width=0.032cm] (2.025607,1.530729) -- (2.974393,2.669271);%
                \draw [line width=0.032cm] (3.025607,2.730729) -- (3.639344,3.467213);%
                
                % Drawing segment B B'
                \draw [line width=0.032cm] (5.962861,1.514856) -- (2.551724,2.879310);%
                \draw [line width=0.032cm] (5.962861,1.514856) -- (3.037139,2.685144);%
                \draw [line width=0.032cm] (2.962861,2.714856) -- (2.551724,2.879310);%
                
                % Drawing segment C C'
                \draw [line width=0.032cm] (3.000000,3.960000) -- (3.000000,1.500000);%
                \draw [line width=0.032cm] (3.000000,3.960000) -- (3.000000,2.740000);%
                \draw [line width=0.032cm] (3.000000,2.660000) -- (3.000000,1.500000);%
                ...
                % Marking point V by circle
                \draw [line width=0.032cm] (3.000000,2.700000) circle (0.040000);%
                \draw (2.970000,2.730000) node [anchor=north west] { $H$ };%
                \color{black}
                }
            \end{tikzpicture}
...
~
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                ...
                % Marking point t_a
                \draw (4.083333,2.441667) node [anchor=west] { $t_a$ };%
                
                % Marking point t_c
                \draw (3.833333,1.916667) node [anchor=west] { $t_c$ };%
                
                % Marking point t_b
                \draw (3.083333,2.541667) node [anchor=south] { $t_b$ };%
                
                % Marking point \frac{b}{2}
                \draw (2.250000,2.125000) node [anchor=east] { $\frac{b}{2}$ };%
                
                % Marking point \frac{b}{2}
                \draw (2.750000,3.375000) node [anchor=east] { $\frac{b}{2}$ };%
                
                % Marking point \frac{c}{2}
                \draw (3.000000,1.500000) node [anchor=north] { $\frac{c}{2}$ };%
                
                % Marking point \frac{c}{2}
                \draw (5.000000,1.500000) node [anchor=north] { $\frac{c}{2}$ };%
                
                % Marking point \frac{a}{2}
                \draw (5.30000,2.125000) node [anchor=west] { $\frac{a}{2}$ };%
                
                % Marking point \frac{a}{2}
                \draw (3.80000,3.375000) node [anchor=west] { $\frac{a}{2}$ };%
                ...
                % Drawing segment A a
                \draw [line width=0.032cm] (2.035777,1.517889) -- (4.500000,2.750000);%
                \draw [line width=0.032cm] (2.035777,1.517889) -- (3.630890,2.315445);%
                \draw [line width=0.032cm] (3.702444,2.351222) -- (4.500000,2.750000);%
                
                % Drawing segment B b
                \draw [line width=0.032cm] (5.962330,1.513453) -- (2.500000,2.750000);%
                \draw [line width=0.032cm] (5.962330,1.513453) -- (3.704336,2.319880);%
                \draw [line width=0.032cm] (3.628997,2.346787) -- (2.500000,2.750000);%
                
                % Drawing segment C c
                \draw [line width=0.032cm] (3.014856,3.962861) -- (4.000000,1.500000);%
                \draw [line width=0.032cm] (3.014856,3.962861) -- (3.651811,2.370472);%
                \draw [line width=0.032cm] (3.681522,2.296194) -- (4.000000,1.500000);%
                ...
                % Marking point T by circle
                \draw [line width=0.032cm] (3.666667,2.333333) circle (0.040000);%
                \draw (3.636667,2.303333) node [anchor=south west] { $T$ };%
                \color{black}
                }
            \end{tikzpicture}
        ...
        \begin{izrek}
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}
                    ...
                    \draw (6.030000,4.970000) node [anchor=south east] { $I$ };%
...
\begin{multicols}{2}
        ...
        \begin{itemize}
            \item raznostranični trikotnik -- vse tri stranice različno dolge, vsi trije koti so različni
                ...
                \item enakokraki trikotnik --  dve stranici enako dolgi  $\Rightarrow$ kota ob osnovnici sta skladna
                ...
                \item enakostranični ali pravilni trikotnik -- vse tri stranice enako dolge $\Rightarrow$ vsi trije koti so skladni
        ...
        \begin{itemize}
            ...
            \item ostrokotni trikotnik -- ima tri ostre notranje kote
                ...
                \item topokotni trikotnik -- ima en topi notranji kot, ostala dva kota ostra
                ...
                \item pravokotni trikotnik -- ima en pravi notranji kot, ostala dva kot ostra
