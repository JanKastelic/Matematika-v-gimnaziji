...
\end{frame}
    ...
    \subsection{Teorija množic}
        ...
        \begin{frame}
            ...
            \end{alertblock}
            % Univerzalna množica ali univerzum (𝓤) je množica vseh elementov, ki v danem primeru nastopajo oz. jih opazujemo.
            % Prazna množica (∅, { }) je množica, ki ne vsebuje nobenega elementa.
