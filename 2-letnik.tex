...
\include{Geometrija_na_ravnini_in_v_prostoru}

\include{Vektorji}

\include{Koreni_lastnosti_funkcij_potencna_funkcija}

\include{Kvadratna_funkcija_kompleksna_stevila}

\include{Eksponentna_in_logaritemska_funkcija}
