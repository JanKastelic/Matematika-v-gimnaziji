...
\begin{center}
    ...
    Popravljanje in pridobivanje ocen -- konferenca \\ 2. letnik -- test B \\ 18. junij 2026 \\ (Geometrija v ravnini; Kotne funkcije; Vektorji)}}}
\end{center}
...
\begin{questions}
    ...
    \question[4]
    Vseh diagonal v pravilnem $n$-kotniku je $54$. Določite, kateri $n$-kotnik je to ter koliko meri notranji kot tega $n$-kotnika.
    ...
    \question[5]
    Razlika velikosti sokotov $\varphi$ in $\psi$ je $25^\circ 27' 44''$.
    ...
    % \begin{parts}
    %     \part[4]
        Izračunajte natančno dolžino stranice $a$ tega triktonika. %in višine na stranico $a$ tega trikotnika.
        ...
        % \part[2]
        % Izračunajte dolžino težiščnice $t_c$.
    ...
    % \question[3]
    % Navpičen $40~m$ visok lesen drog se prelomi tako, 
    % da njegov zgornji konec udari ob vodoravna tla $14~m$ od podnožja droga.
...
\newpage
    ...
    Z baznimi vektorji $\overrightarrow{a}=\overrightarrow{AB}, \overrightarrow{b}=\overrightarrow{AD}$ in $\overrightarrow{c}=\overrightarrow{AE}$ izrazite vektor: 
    % \begin{parts}
    %     \part[3]
    %     $\overrightarrow{MN}$, 
