...
\begin{center}
    ...
    Drugo pisno ocenjevanje znanja \\ 2. letnik -- test A \\ 19. december 2025 \\ (Kotne funkcije; Vektorji)}}}
\end{center}
...
\begin{questions}
    ...
    \question[3]
    Poenostavite izraz. 
    $$ \left(1 + \tan^2x\right)\cdot\cos^2x-\sin^2x$$
    ...
    $$ \dfrac{\sin{135^\circ} + \cos{60^\circ}}{\sin{30^\circ} - \tan{225^\circ}}$$
...
\newpage
    ...
    \question
    V kocki $ABCDEFGH$ je točka $M$ razpolovišče roba $HG$, točka $N$ razdeli rob $AE$ v razmerju \\ $|AN|:|NE|=1:2$.
    ...
    \question[3]
    V trikotniku $\triangle ABC$ z oglišči $A(4,5,-6)$, $B(1,7,0)$ in $C(3,7,-4)$ izračunajte dolžino težiščnice na stranico $AC=b$.
    % \begin{parts}
