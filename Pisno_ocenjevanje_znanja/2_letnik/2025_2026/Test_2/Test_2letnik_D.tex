...
\begin{center}
    ...
    Drugo pisno ocenjevanje znanja -- ponovno \\ 2. letnik -- test D \\ 12. januar 2026 \\ (Kotne funkcije; Vektorji)}}}
\end{center}
...
\begin{questions}
    ...
    \question[4]
    Poenostavite izraz. 
    $$ \left(\dfrac{1}{\cot x}\sin^{-1}x\right)^{-2}+\sin x\tan x\cos x $$
    ...
    $$ \sin^2 55^\circ + \cos^2 305^\circ - \dfrac{\frac{\tan 213^\circ}{\sin 33^\circ}}{\sin 57^\circ} $$
...
\newpage
    ...
    \question
    V kocki $ABCDEFGH$ točka $M$ tretjini rob $HG$, točka $N$ razdeli rob $AE$ v razmerju $|AE|:|NE|=2:1$.
    ...
    \question[4]
    V trikotniku $\triangle ABC$ z oglišči $A(4,5,-6)$, $B(1,7,0)$ in $C(4,0,-3)$ izračunajte oddaljenost težišča trikotnika $\triangle ABC$ od oglišča $C$.
    % \begin{parts}
    ...
    \end{solution}
        ...
        \part[3]
        Določite $x$, da bo vektor $\overrightarrow{v}=(x,x-8,-7)$ vzporeden vektorju $\overrightarrow{AB}$.
    ...
    \end{solution}
        ...
        \part[3]
        Določite $y$, da bo vektor $\overrightarrow{u}=(6y+1,y,10)$ pravokoten na krajevni vektor točke $B$.
    \end{parts}
...
\newpage
    ...
    Izračunajte dolžino vektorja $\overrightarrow{z}=\frac{4}{3}\overrightarrow{y}+\frac{1}{4}\overrightarrow{x}$.
