...
\begin{center}
    ...
    Prvo pisno ocenjevanje znanja -- ponovno \\ 2. letnik -- test D \\ 7. november 2025 \\ (Geometrija v ravnini)}}}
\end{center}
...
\begin{questions}
    ...
    \question[3]
    Zunanji kot v pravilnem $n$-kotniku meri $60^\circ$. Določite, kateri $n$-kotnik je to ter koliko meri notranji kot tega $n$-kotnika.
    ...
    \question[6]
    Konstruirajte romb s podatki $a=4~cm$, $v=3~cm$ in $\alpha<90^\circ$.
    ...
    \begin{figure}[H]
        ...
        % Marking point u
        \draw (4.202602,5.597885) node [anchor=north] { $59^\circ$ };%
    ...
    \question
    V pravokotnem trikotniku sta pravokotni projekciji katet $a$ in $b$ na hipotenuzo $c$ velikosti $a_1=4~cm$ in  $b_1=6~cm$.
    \begin{parts}
        \part[3]
