...
\begin{center}
    ...
    Prvo pisno ocenjevanje znanja -- ponovno \\ 2. letnik -- test E \\ 7. november 2025 \\ (Geometrija v ravnini)}}}
\end{center}
...
\begin{questions}
    ...
    \question[3]
    Zunanji kot v pravilnem $n$-kotniku meri $30^\circ$. Določite, kateri $n$-kotnik je to ter koliko meri notranji kot tega $n$-kotnika.
    ...
    \question[5]
    Razlika velikosti dveh sokotov $\varphi$ in $\psi$ je $67^\circ 7' 6''$.
    ...
    \question[6]
    Konstruirajte romb s podatki $a=5~cm$, $v=4~cm$ in $\alpha<90^\circ$.
    ...
    \begin{figure}[H]
        ...
        % Marking point u
        \draw (4.202602,5.597885) node [anchor=north] { $58^\circ$ };%
    ...
    \question
    V pravokotnem trikotniku sta pravokotni projekciji katet $a$ in $b$ na hipotenuzo $c$ velikosti $a_1=6~cm$ in  $b_1=4~cm$.
    \begin{parts}
        \part[3]
        Izračunajte natančno dolžino stranice $a$ in višine $v$ na hipotenuzo $c$ tega trikotnika.
