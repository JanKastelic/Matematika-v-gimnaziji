...
\begin{center}
    ...
    Četrto pisno ocenjevanje znanja -- manjkajoči \\ 2. letnik -- test B \\ 14. maj 2026 \\ (Kvadratna funkcija)}}}
\end{center}
...
\begin{questions}
    ...
    \question
    Dana je kvadratna funkcija $f(x)=\frac{1}{3}x^2+\frac{1}{3}x-\frac{15}{12}$.
    ...
    \begin{parts}
        ...
        \newpage
        \part[3]
        Graf funkcije $f$ togo premaknemo za vektor $\vec{v}=(0.5,\frac{4}{3})$ in tako dobimo graf funkcije $g$.
    ...
    \begin{parts}
        ...
        \part[4]
        Določite $m$ tako, da bo imela parabola z abscisno osjo dve skupni točki.
        ...
        \part[2]
        Za katero vrednost parametra $m$ enačba ne bo predstavljala parabole in bo imela ta krivulja presečišče z ordinatno osjo. 
