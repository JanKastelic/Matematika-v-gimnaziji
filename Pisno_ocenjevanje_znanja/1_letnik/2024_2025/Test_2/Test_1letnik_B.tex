...
\begin{center}
    ...
    Tretje pisno ocenjevanje znanja \\ 1. letnik -- test B \\ 19. februar 2025 \\ (Deljivost; Racionalna števila)}}}
\end{center}
...
\begin{questions}
    ...
    \question[4]
    Naj bo $a=3^4\cdot 5^4\cdot 7^2$, $b=2\cdot 3^3\cdot 225$ in $c=72\cdot 625$. 
    ...
    \begin{solution}[6cm]
        ...
        Izračun $D(a,b,c)=3^2\cdot 5^2=225$ $1$ točka, in $v(a,b,c)=2^3\cdot 3^5\cdot 5^4\cdot 7^2$ $1$ točka.
    \end{solution}
    
    
    % 2. vprašanje
    \question
    Število $a$ da ostanek $8$ pri deljenju z $10$, število $b$ pa ima pri deljenju s $5$ ostanek $4$.
\begin{parts}
    \part[2]
    Pokažite, da ima $a$ pri deljenju s $5$ ostanek $3$.
    ...
    \begin{parts}
        \part[5]
        $3\frac{3}{5}\cdot \frac{25}{12}-\dfrac{3\frac{3}{8}+\frac{11}{6}}{\frac{19}{8}}$
        ...
        \part[5]
        $3.\overline{6}:(0.5-0.\overline{3})-0.3\overline{72}\cdot 55$
    ...
    \begin{parts}
        ...
        \part[5]
        $\dfrac{x^n-9x^{n-2}}{x^{n+1}+2x^n-3x^{n-1}}; \quad x\neq 0,1$
    ...
    %dodatno vprašanje
    \bonusquestion[2]
    \textit{Dodatna naloga:} Zapišite število $539$ v sedmiškem številskem sestavu.
