...
\begin{center}
    ...
    Peto pisno ocenjevanje znanja \\ 1. letnik -- test C \\ 28. maj 2025 \\ (Koordinatni sistem v ravnini, Funkcija, Premica)}}}
\end{center}
...
\begin{questions}
    ...
    \begin{parts}
        ...
        \part[4]
        $\left\{(x,y)\in\mathbb{R}^2 \mid (y>-2)\land (y=-x)\right\} $
    ...
    % 2. vprašanje
    \question[4]
    Izračunajte ploščino in orientacijo trikotnika $\triangle ABC$ z oglišči v točkah $A(1,-4)$, $B(4,5)$ in $C(-3,4)$.
    ...
    \begin{parts}
        ...
        \part[4]
        Določite implicitno obliko enačbe vzporednice k dani premici, ki poteka skozi točko $(2,3)$. % Premico tudi narišite.
    ...
    x+1, & x\leq 0 \\ 2, & 1<x<2 \\ -2x+4, & x\geq 2
    \end{cases}.$$ 
    ...
    \begin{parts}
        ...
        \part[1]
        Določite območje, kjer je funkcija konstantna.
