...
\begin{center}
    ...
    Tretje pisno ocenjevanje znanja \\ 1. letnik -- test C \\ 19. februar 2025 \\ (Deljivost; Racionalna števila)}}}
\end{center}
...
\begin{questions}
    ...
    \question[4]
    Naj bo $a=3^4\cdot 5^4\cdot 7^3$, $b=2\cdot 3^3\cdot 225$ in $c=72\cdot 625$. 
    ...
    \begin{solution}[6cm]
        Za zapisa $b=2\cdot 3^5\cdot 5^2$ in $c=2^3\cdot 3^2\cdot 5^4$ po $1$ točka. 
        Izračun $D(a,b,c)=3^2\cdot 5^2=225$ $1$ točka, in $v(a,b,c)=2^3\cdot 3^5\cdot 5^4\cdot 7^3$ $1$ točka.
    \end{solution}
    
    
    % 2. vprašanje
    \question
    Število $a$ da ostanek $6$ pri deljenju z $10$, število $b$ pa ima pri deljenju s $5$ ostanek $3$.
\begin{parts}
    \part[2]
    Pokažite, da ima $a$ pri deljenju s $5$ ostanek $1$.
    
    \begin{solution}[4cm]
        Za zapis $a=10k+6$ $1$ točka, sklep $a=5(2k+1)+1$ $1$ točka.
    \end{solution}
    ...
    \begin{solution}[3cm]
        Za zapis $b=5l+3$ $1$ točka, izračun $2a+b=20k+12+5l+3$ $1$ točka, končen sklep $2a+b=5(4k+l+3)$ $1$ točka.
    \end{solution}
    ...
    \begin{parts}
        \part[5]
        $\frac{25}{12}\cdot 3\frac{3}{5}-\dfrac{\frac{11}{6}+3\frac{3}{8}}{\frac{19}{8}}$

        \begin{solution}[7cm]
            \begin{align*} 
                3\frac{3}{5}\cdot \frac{25}{12}-\dfrac{3\frac{3}{8}+\frac{11}{6}}{\frac{19}{8}}&=\frac{18}{5}\cdot \frac{25}{12}-\dfrac{\frac{27}{8}+\frac{11}{6}}{\frac{19}{8}}= \\
        ...
        \part[5]
        $0.3\overline{72}\cdot 55 - 3.\overline{6}:(0.5-0.\overline{3})$

        \begin{solution}[4cm]
            \begin{align*}
                0.3\overline{72}\cdot 55 - 3.\overline{6}:(0.5-0.\overline{3})&=\frac{41}{110}\cdot 55 - 3\frac{2}{3}:(\frac{1}{2}-\frac{1}{3})= \\
                                                                            &=\frac{41}{2} - \frac{11}{3}:\frac{1}{6}= \\
                                                                            &= \frac{41}{2}-\frac{11}{3}\cdot \frac{6}{1}= \\
                                                                            &= \frac{41}{2}-22= \\
                                                                            &= -\frac{3}{2}
            \end{align*}
            Za pravilno zapisano število $0.3\overline{72}$ z ulomkom $1$ točka, pravilno zapisani števili $3.\overline{6}$ in $0.\overline{3}$ z ulomkoma $1$ točka, pravilno množenje in deljenje ulomkov $1$ točka, pravilno odštevanje ulomkov $1$ točka, končen rezultat $1$ točka.
        \end{solution}
    ...
    \begin{parts}
        ...
        \begin{solution}[7cm]
            \begin{align*}
                4(81x^2-1)(36x-4)^{-1}&= \dfrac{4(81x^2-1)}{36x-4}= \\
                                    &= \dfrac{4(9x-1)(9x+1)}{4(9x-1)}= \\
                                    &= 9x+1
            \end{align*}
        ...
        \part[5]
        $\dfrac{9x^{n-2}-x^n}{3x^{n-1}-2x^n-x^{n+1}}; \quad x\neq 0,1$

        \begin{solution}[7cm]
            \begin{align*}
                \dfrac{x^n-9x^{n-2}}{x^{n+1}+2x^n-3x^{n-1}} &= \dfrac{x^{n-2}(x^2-9)}{x^{n-1}(x^{2}+2x-3)}= \\
                                                            &= \dfrac{x^{n-2}(x-3)(x+3)}{x^{n-1}(x+3)(x-1)}= \\
                                                            &= \dfrac{x+3}{x(x-1)}
            \end{align*}
    ...
    \newpage
        ...
        \begin{parts}
            ...
            \part[5]
            $\dfrac{x^{-1}}{1-x^{-1}}+\dfrac{2x^{-2}}{1-2x^{-1}+x^{-2}}; \quad x\neq 1$
            ...
            \part[5]
            $\dfrac{(a-1)^{-1}-(a+1)^{-1}}{\frac{a}{a^2-1}+a}; \quad a\neq 0$
    ...
    %dodatno vprašanje
    \bonusquestion[2]
    \textit{Dodatna naloga:} Zapišite število $525$ v sedmiškem številskem sestavu.
    ...
    \begin{solution}[7cm]
        \begin{align*}
            ...
            1 &= 7\cdot 0 + 1
        \end{align*}
        Za pravilno zapisan algoritem $1$ točka, zapis števila v sedmiškem sistemu $525_{(10)}=1350_{(7)}$ $1$ točka.
    \end{solution}
