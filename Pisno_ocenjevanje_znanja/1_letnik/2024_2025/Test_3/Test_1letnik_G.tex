...
\begin{center}
    ...
    Popravljanje in pridobivanje ocen -- tretje pisno ocenjevanje znanja \\ 1. letnik -- test G \\ 12. junij 2025 \\ (Deljivost; Racionalna števila)}}}
\end{center}
...
\begin{questions}
    ...
    % 2. vprašanje
    \question
    Zapišite po besedilu in izračunajte število $w$ oziroma $z$.
    \begin{parts}
    \part[2]
        Če število $w$ delimo s številom $77$, dobimo količnik $7$ in ostanek $17$.
    ...
    \part[3]
        Če število $5713$ delimo s številom $z$, dobimo količnik $15$ in ostanek $13$.
    ...
    % \\ Elipsa:  \fillin[b c d][2cm]
        ...
        % 4. vprašanje
        \question[3]
        Ali je število $697$ praštevilo? Utemeljite.
    ...
    \begin{parts}
        \part[5]
        $\dfrac{\frac{3}{2}-\frac{4}{3}}{1+\left(\frac{4}{5}\right)^{-1}}-1\frac{2}{3}\left(\frac{4}{7}:2\frac{1}{2}-\frac{2}{7}\right)$

        \begin{solution}[7cm]
            \begin{align*} 
                \dfrac{1\frac{5}{6}+\frac{27}{8}}{\frac{19}{12}}-2\frac{1}{12}\cdot \frac{18}{5} &=\dfrac{\frac{11}{6}+\frac{27}{8}}{\frac{19}{12}}-\frac{25}{12}\cdot\frac{18}{5}= \\
    ...
    \begin{parts}
        ...
        \part[5]
        $\dfrac{(\frac{1}{7})^{-1}b^3\cdot 10^{-3}(b^{-3})^3 (10^{-4})^3 (a^0+2b^0)}{21(b^{-3}10^{-8})^2}; \quad a,b\neq 0$
    ...
    \newpage
        ...
        \begin{parts}
            ...
            \part[5]
            $\dfrac{(a+2)^{-1}-(a-2)^{-1}}{4a+\frac{16a}{a^2-4}}; \quad a\neq 0$
    ...
    %dodatno vprašanje
    % \bonusquestion[2]
    % \textit{Dodatna naloga:} Zapišite število $523$ v osmiškem številskem sestavu.
    ...
    %         1 &= 8\cdot 0 + 1
    %     \end{align*}
    %     Za pravilno zapisan algoritem $1$ točka, zapis števila v osmiškem sistemu $523_{(10)}=1013_{(8)}$ $1$ točka.
    % \end{solution}
