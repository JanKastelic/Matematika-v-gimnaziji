...
\begin{center}
    ...
    Tretje pisno ocenjevanje znanja -- ponovno \\ 1. letnik -- test F \\ 17. marec 2025 \\ (Deljivost; Racionalna števila)}}}
\end{center}
...
\begin{questions}
    ...
    \begin{parts}
    \part[2]
        Če število $x$ delimo s številom $123$, dobimo količnik $7$ in ostanek $55$.
    ...
    \begin{parts}
        \part[5]
        $\dfrac{1\frac{5}{6}+\frac{27}{8}}{\frac{19}{12}}-2\frac{1}{12}\cdot \frac{18}{5}$
        ...
        \part[5]
        $5.\overline{6}:(2.5-2.\overline{3}) - 0.3\overline{72}\cdot 110 $
    ...
    \begin{parts}
        ...
        \part[5]
        $\dfrac{7^{3n-2}-7^{3n-1}}{7^{3n-3}+3\cdot 7^{3n-2}-7^{3n-4}}$
