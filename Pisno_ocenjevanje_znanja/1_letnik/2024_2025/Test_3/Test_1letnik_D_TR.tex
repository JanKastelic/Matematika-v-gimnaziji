...
\begin{center}
    ...
    Tretje pisno ocenjevanje znanja -- ponovno \\ 1. letnik -- test D \\ 17. marec 2025 \\ (Deljivost; Racionalna števila)}}}
\end{center}
...
\begin{questions}
    ...
    \begin{parts}
    \part[2]
        Če število $x$ delimo s številom $123$, dobimo količnik $7$ in ostanek $53$.
    ...
    \begin{parts}
        \part[5]
        $\dfrac{\frac{11}{6}+3\frac{3}{8}}{\frac{19}{12}}-\frac{25}{12}\cdot 3\frac{3}{5}$
        ...
        \newpage
        \part[5]
        $0.3\overline{72}\cdot 110 - 5.\overline{6}:(1.5-1.\overline{3})$
    ...
    %dodatno vprašanje
    \bonusquestion[2]
    \textit{Dodatna naloga:} Zapišite število $525$ v osmiškem številskem sestavu.
