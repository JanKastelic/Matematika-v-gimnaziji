...
\begin{center}
    ...
    Tretje preverjanje znanja \\ 1. letnik \\ 11. februar 2025 \\ (Deljivost; Racionalna števila)}}}
\end{center}
...
\begin{questions}
    ...
    \question[4]
    Naj bo $a=777$, $b=1200$. 
    Določite največji skupni delitelj $D(a,b)$ in najmanjši skupni večkratnik $v(a,b)$. Vrednost slednjega lahko pustite zapisano s potencami.
    ...
    % 2. vprašanje
    \question
    Število $a$ da ostanek $5$ pri deljenju z $8$, število $b$ pa ima pri deljenju s $4$ ostanek $3$.
\begin{parts}
    \part[2]
    Pokažite, da ima $a$ pri deljenju s $4$ ostanek $1$.
    ...
    \part[3]
    Pokažite, da je število $a+b$ deljivo s $4$.
    ...
    % \\ Elipsa:  \fillin[b c d][2cm]
        ...
        % 4. vprašanje
        \question[3]
        Ali sta števili $552$ in $283$ tuji? Pokažite z računom.
