...
\begin{center}
    ...
    Popravljanje in pridobivanje ocen -- konferenca \\ 1. letnik -- test B \\ 17. junij 2025 \\ (Deljivost; Racionalna števila; Realna števila; Koordinatni sistem v ravnini; Funkcija; Premica)}}}
\end{center}
...
\begin{questions}
    ...
    \question[4]
    Določite največji skupni delitelj in najmanjši skupni večkratnik števil $140$, $230$ in $320$.
    ...
    Izračunajte vrednost izraza.
        $$\left(2.1\overline{6}+1\dfrac{4}{3}\right)\cdot 0.\overline{2} $$
    ...
    %     \part[4]
        $\left(\dfrac{a-1}{a^2-4}-\dfrac{6}{a^2+2a}\right):\dfrac{1+a^{-1}-20a^{-2}}{1+2a^{-1}}$
    ...
    $$ \left(2-\sqrt{3}\right)\left(2+\sqrt{3}\right)-\left(2\sqrt{7}+3\right)^2 $$
    ...
    % 5. vprašanje
    \question[4]
    Oče je v oporoki razdelil denar trem sinovom na naslednji način:
    Miha dobi $22~\%$ celotnega zneska, Marko dobi $500~€$, Matjaž pa $200~€$ več kot Miha.
    Koliko denarja je oče zapustil sinovom in koliko denarja je dobil vsak izmed njih?
...
\newpage
    % 4. vprašanje
    \question[5]
    Izračunajte in grafično upodobite vse vrednosti $x$, za katere je: 
    $$2x+3<5x+7\leq \dfrac{x}{3}+3.$$
    ...
    % \begin{parts}
    %     \part[4]
        $$\left\{(x,y)\in\mathbb{R}^2;~\lvert x\rvert >3\right\}$$
...
\newpage
    ...
    % 3. vprašanje
    \question
    Dana je premica z enačbo $2x-3y+3=0$, ki seka koordinatni osi v točkah $M$ in $N$.
    ...
    \begin{parts}
        ...
        \part[4]
        Določite segmentno obliko enačbe pravokotnice k dani premici, ki poteka skozi točko $(0,4)$. % Premico tudi narišite.
        ...
        \part[4]
        Izračunajte obseg trikotnika $\triangle OMN$, kjer je $O$ koordinatno izhodišče.
