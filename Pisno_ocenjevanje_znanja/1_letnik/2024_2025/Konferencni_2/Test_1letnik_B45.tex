...
\newpage
    ...
    % 2. vprašanje
    % \question[4]
    % Izračunajte obseg trikotnika $\triangle ABC$ z oglišči v točkah $A(3,2)$, $B(-1,4)$ in $C(-2,-1)$.
    ...
    \begin{parts}
        ...
        \part[3]
        Izračunajte ničle in začetno vrednost funkcije ter določite ali je funkcija surjektivna.
