...
\begin{center}
    ...
    Popravljanje in pridobivanje ocen -- konferenca \\ 1. letnik -- test B \\ 23. januar 2025 \\ (Osnove logike in teorije množic; Naravna in cela števila; Potence in izrazi; Deljivost)}}}
\end{center}
...
\newpage
    ...
    \question[4]
    Določite pravilnost izjave $ A\Rightarrow  B\Leftrightarrow \lnot(\lnot A\land B)$ glede na izbor izjav $A$ in $B$. Upoštevajte vrstni red operacij.
    ...
    \begin{parts}
        ...
        \part 
        Če število $3$ ni naravno število, potem je naravnih števil števno končno.\\
        \part
