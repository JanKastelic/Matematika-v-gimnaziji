...
\begin{center}
    ...
    Četrto pisno ocenjevanje znanja \\ 1. letnik -- test C \\ 16. april 2025 \\ (Realna števila)}}}
\end{center}
...
\begin{questions}
    ...
    $$ \dfrac{\sqrt{5}}{\sqrt{5}+1}-\dfrac{5-3\sqrt{5}}{4\sqrt{5}}+\left(1+\sqrt{5}\right)^2-\sqrt{125} $$
    ...
    % 10. vprašanje
    \question[4]
    Izlet v Grčijo se je najprej podražil za $7~\%$, nato pa še za $10~\%$. 
    Koliko je stal na začetku, če zdaj stane $2354~€$?
    ...
    % dodatno vprašanje
    \bonusquestion[2]
    \textit{Dodatna naloga:} Natančno izračunajte. $$ \left(\sqrt{3}+\sqrt{2}\right)\sqrt{5-2\sqrt{6}} $$
