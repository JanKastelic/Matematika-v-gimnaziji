...
\begin{center}
    ...
    Četrto pisno ocenjevanje znanja -- ponovno \\ 1. letnik -- test F \\ 7. maj 2025 \\ (Realna števila)}}}
\end{center}
...
\begin{questions}
    ...
    $$ \dfrac{2\sqrt{27b^5a^{-1}}}{\sqrt{12ba^{-5}}}:\sqrt{b} $$
    ...
    \question[3]
    Rešite enačbo.
    $$ \dfrac{1}{8}\left(2+\dfrac{2}{3}x\right)+\dfrac{1}{4}\left(\dfrac{1}{6}-\dfrac{x}{2}\right)=0 $$
    ...
    $$ \left(x-2<5\right)\land\left(2x\leq 3(x-2)\right) $$
...
\newpage
    ...
    % 5. vprašanje
    \question[4]
    Prva cev sama napolni bazen v $4$ urah, druga sama pa v $8$ urah. Drugo cev odpremo eno uro kasneje kot prvo.
    ...
    $$\left\lvert x+6 \right\rvert + \left\lvert x-4 \right\rvert $$
    ...
    % 10. vprašanje
    \question[4]
    Izlet na Japonsko se je najprej podražil za $6~\%$, nato pa pocenil za $5~\%$. 
    Koliko je stal na začetku, če zdaj stane $3021~€$?
