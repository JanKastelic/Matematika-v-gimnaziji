...
\begin{center}
    ...
    Četrto pisno ocenjevanje znanja -- ponovno \\ 1. letnik -- test D \\ 7. maj 2025 \\ (Realna števila)}}}
\end{center}
...
\begin{questions}
    ...
    $$ \dfrac{2\sqrt{27a^5b^{-1}}}{\sqrt{12ab^{-5}}}:\sqrt{a} $$
    ...
    \question[3]
    Rešite enačbo.
    $$ \dfrac{1}{4}\left(\dfrac{x}{2}-\dfrac{1}{6}\right)-\dfrac{1}{8}\left(2+\dfrac{2}{3}x\right)=0 $$
    ...
    $$ \left(x-2<2\right)\land\left(2x\leq 3(x-1)\right) $$
    ...
    % 10. vprašanje
    \question[4]
    Izlet na Japonsko se je najprej podražil za $5~\%$, nato pa pocenil za $4~\%$. 
    Koliko je stal na začetku, če zdaj stane $3024~€$?
