...
\begin{center}
    ...
    Drugo pisno ocenjevanje znanja -- ponovno \\ 1. letnik -- test E \\ 19. december 2025 \\ (Potence in izrazi; Deljivost)}}}
\end{center}
...
\begin{parts}
    \part[4]
    $7\cdot\left(-5+2\cdot 3\right)^{n+3}+\left(-1\right)^{2n+2}-\left(-1\right)^{2n+1}$
    ...
    \part[4]
    $\left(x^3\left(-y^2\right)^5(-z)\right)^3\left(xy^2z\right)^3\left(x^2y^3\left(-z^2\right)^3\right)$
    ...
    % 2. vprašanje
    \question[5]
    Skrčite izraz in rezultat razstavite: $(x-4)^2+(x+1)^3-7x(x-1)-17$.
    ...
    % 4. vprašanje
    \question
    Določite neznano števko, da bo število $\overline{vvvvvvv4}$ deljivo
    \begin{parts}
        \part[2]
        s številom $4$.
...
% 5. vprašanje
    ...
    \question[4]
    Določite največji skupni delitelj $D$ in najmanjši skupni večkratnik $v$ izrazov $3x^2+6x-9$ in $9x^2-9$.
    ...
    \end{solution}
        ...
        \part[3]
        Če število $5611$ delimo s število $y$, dobimo količnik $29$ in ostanek $14$.
    \end{parts}
