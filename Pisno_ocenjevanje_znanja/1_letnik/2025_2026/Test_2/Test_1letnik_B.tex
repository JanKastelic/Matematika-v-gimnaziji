...
\begin{center}
    ...
    Drugo pisno ocenjevanje znanja \\ 1. letnik -- test B \\ 4. december 2025 \\ (Potence in izrazi; Deljivost)}}}
\end{center}
...
\begin{parts}
    \part[4]
    $\left(\left(-5\right)^2+\left(-2\right)^3\right)\cdot\left(-1\right)^{2025}-\left(-\left(-4\right)^2+\left(-3\right)^2\cdot\left(-2\right)\right)-1^{2026}$
    ...
    \part[3]
    $3\cdot 2^{2n+1}-2\cdot 4^{n+1}-2\cdot 2^{2n+2}$
    ...
    % 2. vprašanje
    \question[5]
    Skrčite izraz in rezultat razstavite: $(7a-2b)^2-6(4a^2-b^2)-(5a+2b)(5a-2b)$.
    ...
    % 4. vprašanje
    \question
    Določite neznani števki, da bo število $\overline{7c777777777a}$ deljivo
    \begin{parts}
        \part[1]
        s številom $2$.
...
% 5. vprašanje
    ...
    \question[4]
    Naj bo $a=36\cdot 625$, $b=3^4\cdot 5^4\cdot 7\cdot 13$ in $c=2^2\cdot 3^2\cdot 175$. 
    ...
    Pokažite, da je število $m+3n$ deljivo s $3$.
