...
\begin{center}
    ...
    Drugo pisno ocenjevanje znanja -- ponovno \\ 1. letnik -- test D \\ 19. december 2025 \\ (Potence in izrazi; Deljivost)}}}
\end{center}
...
\begin{parts}
    \part[4]
    $\left(-1\right)^{2n+2}+7\cdot\left(-5+2\cdot 3\right)^{n+4}-\left(-1\right)^{2n+1}$
    ...
    \part[4]
    $\left(xy^2z\right)^3\left(x^3\left(-y^2\right)^5(-z)\right)^3\left(x^2y^3\left(-z^2\right)^3\right)$
    ...
    % 2. vprašanje
    \question[5]
    Skrčite izraz in rezultat razstavite: $(x+1)^3+(x-4)^2-7x(x-1)-17$.
    ...
    % 4. vprašanje
    \question
    Določite neznano števko, da bo število $\overline{ppppppp4}$ deljivo
    \begin{parts}
        \part[2]
        s številom $4$.
...
% 5. vprašanje
    ...
    \question[4]
    Določite največji skupni delitelj $D$ in najmanjši skupni večkratnik $v$ izrazov $2x^2+2x-4$ in $4x^2-4$.
    ...
    \end{solution}
        ...
        \part[3]
        Če število $5612$ delimo s število $y$, dobimo količnik $29$ in ostanek $15$.
    \end{parts}
