...
\begin{center}
    ...
    Popravljanje in pridobivanje ocen -- peto pisno ocenjevanje znanja \\ 1. letnik -- test C \\ 15. junij 2026 \\ (Koordinatni sistem v ravnini, Funkcija, Premica)}}}
\end{center}
...
\begin{questions}
    ...
    \begin{parts}
        ...
        \part[4]
        $\left\{(x,y)\in\mathbb{R}^2 \mid (y=1)\land (|x|>1)\right\} $
    ...
    % 3. vprašanje
    \question
    Dana je premica z enačbo $y=\frac{2}{5}x+1$, ki seka koordinatni osi v točkah $M$ in $N$.
    ...
    \begin{parts}
        ...
        \part[4]
        Določite segmentno obliko enačbe vzporednice k dani premici, ki poteka skozi točko $(3,4)$. % Premico tudi narišite.
    ...
    % 4. vprašanje
    \question
        Določite vrednost parametra $a$, da bo premica $3x-2by+8=0$:
        \begin{parts}
            \part[2] 
            potekala skozi točko $(2,3)$,
            ...
            \part[3] 
            imela diferenčni količnik enak $6$.
