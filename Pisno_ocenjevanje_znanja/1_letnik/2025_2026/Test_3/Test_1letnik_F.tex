...
\begin{center}
    ...
    Popravljanje in pridobivanje ocen -- tretje pisno ocenjevanje znanja \\ 1. letnik -- test F \\ 15. junij 2026 \\ (Racionalna števila)}}}
\end{center}
...
\begin{questions}
    ...
    \begin{parts}
        ...
        \part[5]
        $0.12\overline{3333}\cdot \left(1.2-0.6\cdot\left(0.18-0.06\right)\right)^{-1}$
    ...
    \newpage
        ...
        \begin{parts}
            ...
            \part[5]
            $\left(\dfrac{x^{-2}-1}{x^{-2}-x^{-4}}\right)^{-1}+1+x^{-2}$
    ...
    \begin{parts}
        ...
        \part[4]
        $\left(\dfrac{\left(\dfrac{2}{x^{-2}}\right)^{-1}}{\left(\dfrac{1}{x^2}\right)^{-1}}\right)^{-1}$
