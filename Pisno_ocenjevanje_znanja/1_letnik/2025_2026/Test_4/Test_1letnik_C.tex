...
\begin{center}
    ...
    Popravljanje in pridobivanje ocen -- četrto pisno ocenjevanje znanja \\ 1. letnik -- test C \\ 15. junij 2026 \\ (Realna števila)}}}
\end{center}
...
\begin{questions}
    ...
    \question[5]
    Rešite enačbo.
    $$ \dfrac{x-4}{x+1}=\dfrac{x+4}{x-2} - \dfrac{x^2+24}{x^2-x-2}$$
    ...
    \question[5]
    Izračunajte natančno vrednost izraza.
    $$ \left\lvert \lvert\sqrt{5}-2\rvert+\sqrt{5} -  \lvert\sqrt{5}-4\rvert\right\rvert+\left\lvert-\sqrt{5}\right\rvert $$
