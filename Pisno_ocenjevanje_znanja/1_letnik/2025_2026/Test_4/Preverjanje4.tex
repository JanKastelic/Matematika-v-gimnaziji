...
\begin{center}
    ...
    Četrto preverjanje znanja \\ 1. letnik \\ 30. marec 2026 \\ (Realna števila)}}}
\end{center}
...
\begin{questions}
    ...
    $$\dfrac{\sqrt{3}+1}{\sqrt{3}}-\dfrac{\sqrt{3}-1}{\sqrt{3}+1}+\sqrt{0.16}-\sqrt[3]{-27}+\sqrt{0.64}+\sqrt{48}-\sqrt{27}$$
    ...
    \question
    Ula je izmerila, da ima vreča $51~kg$, natančna masa vreče pa je $50~kg$.
    Izračunajte absolutno in relativno napako Uline meritve.
