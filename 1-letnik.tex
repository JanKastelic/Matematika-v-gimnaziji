...
\include{Naravna_in_cela_stevila_izrazi_enacbe_neenacbe}

\include{Deljivost_izjave_mnozice}

\include{Racionalna_stevila}

\include{Realna_stevila_statistika}

\include{Pravokotni_koordinatni_sistem_linearna_funkcija}
